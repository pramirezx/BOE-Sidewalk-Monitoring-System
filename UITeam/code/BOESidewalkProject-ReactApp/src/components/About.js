...
import googleAPI from "./images/web/googleAPI.png"
        ...
        <div>
            ...
            <div id="Software" class="container-fluid text-center">
                ...
                <div class="row slideanim">
                    ...
                    <div class="col-sm-3">
                        <span><img src={ azure } alt="Logo" style={{width:"80px"}} /></span>
                        <h4>Azure</h4>
                    </div>
                    <div class="col-sm-3">
                        <span><img src={ node } alt="Logo" style={{width:"100px"}} /></span>
                        <h4>Node.js</h4>
                    </div>
                    <div class="col-sm-3">
                        <span><img src={ javascript } alt="Logo" style={{width:"70px"}} /></span>
                        <h4>Javascript</h4>
                    </div>
                ...
                <div class="row slideanim">
                    ...
                    <div class="col-sm-3">
                        <span><img src={ logo192 } alt="Logo" style={{width:"80px"}} /></span>
                        <h4>React</h4>
                    </div>
                    <div class="col-sm-3">
                        <span><img src={ image } alt="Logo" style={{width:"70px"}} /></span>
                        <h4>Image Segmentation</h4>
                    </div>
                    <div class="col-sm-3">
                        <span><img src={ googleAPI } alt="Logo" style={{width:"130px"}} /></span>
                ...
                <div class="container-fluid text-center text-md-left">
                    <div class="row">
                        ...
                        <div class="col-md-6 mt-md-0 mt-3">
                            ...
                            <h5 class="text-uppercase"><img src="https://engpermitmanual.lacity.org/profiles/boe/themes/custom/boe_la/images/brand.png" alt="Logo" style={{"float":"left","width":"100px"}} target="_blank" rel="noopener noreferrer" /></h5>

...
class Render extends Component {
        ...
        axios.get(url)
            ...
            .then(res => {
                ...
                if(pics.length !== 0){
                    this.setState({
                        currentPics: pics,
                        currentPic: `https://swbotblob.blob.core.windows.net/csulaswproject/GoProFrontImages%2F${pics[0].IMAGE_NAME}?sv=2019-10-10&si=csulaswproject-17C19A6298B&sr=c&sig=xZ2soDIU1tHpJVeQVKnAYykG32Sggh3C5xNTnv1%2FB6Y%3D&_=1647475835246`,
                        picNum: 0,
                        currentPicName: pics[0].IMAGE_NAME,
    ...
    nextPicHandler(val){
        ...
        if(num < this.state.currentPics.length){
            this.setState({
                currentPic: `https://swbotblob.blob.core.windows.net/csulaswproject/GoProFrontImages%2F${this.state.currentPics[num].IMAGE_NAME}?sv=2019-10-10&si=csulaswproject-17C19A6298B&sr=c&sig=xZ2soDIU1tHpJVeQVKnAYykG32Sggh3C5xNTnv1%2FB6Y%3D&_=1647475835246`,
                picNum: num,
                currentPicName: this.state.currentPics[num].IMAGE_NAME,
    ...
    prevPicHandler(val){
        ...
        if(num >= 0){
            ...
            this.setState({
                currentPic: `https://swbotblob.blob.core.windows.net/csulaswproject/GoProFrontImages%2F${this.state.currentPics[this.state.currentPics.length - 1].IMAGE_NAME}?sv=2019-10-10&si=csulaswproject-17C19A6298B&sr=c&sig=xZ2soDIU1tHpJVeQVKnAYykG32Sggh3C5xNTnv1%2FB6Y%3D&_=1647475835246`,
                        ...
                        <div class="col-sm-4">
                            <div class="card bg-light text-dark">
                                <div class="card-body">
                                    ...
                                    <p>Date: { (this.state.currentDate !== '') ? this.state.currentDate : '...' }</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-2">
                        ...
                        <div class="container-fluid text-center text-md-left">
                            <div class="row">
                                ...
                                <div class="col-md-6 mt-md-0 mt-3">
                                    ...
                                    <h5 class="text-uppercase"><img src="https://navigatela.lacity.org/navigatela/images/NavLA.png" alt="Logo" style={{"float":"left","width":"100px"}} /></h5>
                                    <br /><p>200 N Spring St,<br />Los Angeles, CA 90012</p>
